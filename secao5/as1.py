...
async def preocessar_dados(quantidade: int, dados: asyncio.Queue):
    ...
    while processados < quantidade:
        ...
        processados += 1
        await asyncio.sleep(0.001)
    print(f"Foram processados {quantidade} itens.")
...
if __name__ == "__main__":
    ...
    el.run_until_complete(gerar_dados(total, dados))
    el.run_until_complete(preocessar_dados(total * 2, dados))
    el.close()
